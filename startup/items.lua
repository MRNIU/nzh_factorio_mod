...
--
-- items.lua for MRNIU/nzh_factorio_mod.
...
chest9_items = {
	-- 产能插件
	{ name = "productivity-module", count = 1200 },
	-- 速度插件	
	{ name = "speed-module",        count = 1200 },
}

-- 物品箱 10 物品
chest10_items = {
	-- 产能插件3
	{ name = "productivity-module-3", count = 1000 },
	-- 物流机器人
	{ name = "logistic-robot",        count = 200 },
	-- 修理包
	{ name = "repair-pack",           count = 200 },
	-- 电力采矿机
	{ name = "electric-mining-drill", count = 200 },
}
