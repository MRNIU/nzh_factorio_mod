...
local mrill_level = settings.startup["nzh_mining_drill"].value
if mrill_level == 1 then
    data.raw["mining-drill"]["electric-mining-drill"].mining_speed = 15
elseif mrill_level == 2 then
    data.raw["mining-drill"]["electric-mining-drill"].mining_speed = 30
elseif mrill_level == 3 then
